    ...
    '@graph': [
      ...
      },
      {
        ...
        hasOfferCatalog: {
          ...
          itemListElement: [
            { '@type': 'Offer', itemOffered: { '@type': 'Thing', name: 'Injectable Steroids UK' } },
            { '@type': 'Offer', itemOffered: { '@type': 'Thing', name: 'Oral Steroids UK' } },
            { '@type': 'Offer', itemOffered: { '@type': 'Thing', name: 'SARMs UK' } },
            { '@type': 'Offer', itemOffered: { '@type': 'Thing', name: 'PCT & Support UK' } },
            { '@type': 'Offer', itemOffered: { '@type': 'Thing', name: 'HGH & Peptides UK' } },
            { '@type': 'Offer', itemOffered: { '@type': 'Thing', name: 'Fat Burners UK' } },
          ],
        },
      },
    ],
